...
def test_receive_user_and_cities_view(api_client, monkeypatch, fake):
    ...
    monkeypatch.setattr(
        "devgrid_api.usecases.add_user_and_cities_to_user_collection", mock_add_user_and_cities_to_user_collection
    )
    monkeypatch.setattr(
        "devgrid_api.usecases.add_user_cities_to_cities_collection", mock_add_user_cities_to_cities_collection
    )
...
def test_get_user_percentage_of_completeness_and_city_data_view(api_client, monkeypatch, fake):
    ...
    monkeypatch.setattr(
        "devgrid_api.api.v1.views.get_user_cities_percentage", mock_get_user_cities_percentage
    )
