...
from devgrid_api.mongodb.queries.general_queries import (
...
def test_insert_one_document_query(fake, monkeypatch):
    ...
    monkeypatch.setattr(
        "devgrid_api.mongodb.queries.general_queries.MongoConnection.insert_document",
...
def test_bulk_insert_data_query(fake, monkeypatch):
    ...
    monkeypatch.setattr(
        "devgrid_api.mongodb.queries.general_queries.MongoConnection.bulk_insert_documents",
